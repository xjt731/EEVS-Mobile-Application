...
public class ProgramAdapterTwo extends RecyclerView.Adapter<ProgramAdapterTwo.ViewHolder> {
...
//            rowDescription = itemView.findViewById(R.id.textView2);
    ...
    public ProgramAdapterTwo(Context context, String[] programNameList, String[] programDescriptionList, int[] images){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.single_item_two, parent, false);
